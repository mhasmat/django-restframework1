...
urlpatterns = [
    ...
    path('comic-stock-filtered/', comic_list_stock_ordered_api_view, name='comic_list_stock_ordered_api_view'),
    path('comic-ordered-by/', comic_list_ordered_by_api_view, name='comic_list_ordered_by_api_view')
]
